            ...
            <a-card title="密码规则配置">
                <a-form layout="vertical">
                    <a-form-item label="密码长度">
                        <a-slider v-model:value="config.length" :min="6" :max="32"
                    ...
                    <a-form-item label="排除易混淆字符">
                        <a-checkbox v-model:checked="config.excludeAmbiguous">
                            排除 0O1lI
                        </a-checkbox>
                    </a-form-item>
                </a-form>
        ...
        <a-col :span="12">
            <a-card title="生成结果">
                <div class="result-container">
                    ...
                    <div class="copy-button-wrapper">
                        <a-tooltip title="复制密码">
                            <a-button type="link" @click="copyPassword" :disabled="!password">
                                <copy-outlined />
                            </a-button>
                        </a-tooltip>
                    </div>
                ...
                <div class="password-strength">
                    <a-alert :message="strength.label" :type="strength.type" :description="strength.description"
                        show-icon />
                </div>
            </a-card>
        </a-col>
