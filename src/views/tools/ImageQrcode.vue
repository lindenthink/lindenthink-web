<template>
    <a-row :gutter="16">
        ...
        <a-col :span="12">
            <a-card title="输入文本">
                <a-textarea v-model:value="inputText" placeholder="请输入要生成二维码的内容"
                    :auto-size="{ minRows: 10, maxRows: 20 }" allow-clear />
                <a-button type="primary" style="margin-top: 16px" @click="generateQrCode">
                    生成二维码
                </a-button>
            </a-card>
        </a-col>
        ...
        <a-col :span="12">
            <a-card title="生成二维码">
                ...
                <a-button type="primary" style="margin-top: 16px" @click="downloadQrCode" :disabled="!qrCodeValue">
                    下载二维码
                </a-button>
            </a-card>
        </a-col>
